...
const BusinesstHotels = () => {
  ...
  useEffect(() => {
    const fetchListings = async () => {
      try {
        ...
        const businessListings = data.filter(listing => listing.hotelType === 'business');
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-3xl font-thin underline text-black font-serif text-center mb-10">Business Hotels</h1>
...
export default BusinesstHotels ;
