  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form className='flex flex-col gap-4'>
        ...
        <input type="password" placeholder='Enter Password' className='border p-3 rounded-lg' id = 'enter password' />
        <input type="password" placeholder='Confirm Password' className='border p-3 rounded-lg' id = 'password' />
