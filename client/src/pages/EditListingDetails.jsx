...
const EditListingDetails = () => {
    ...
    return (
        <div className='container mx-auto p-6'>
            <h1 className='text-3xl font-semibold text-black text-center mb-6'>Edit Listing</h1>
            {loading && <p>Loading...</p>}
            ...
            {listing && (
                <form onSubmit={handleSubmit} className='space-y-6'>
                    ...
                    <div className='mt-4'>
                        ...
                        {files.length > 0 && <p className='text-blue-700'>{files.length} images selected</p>}
