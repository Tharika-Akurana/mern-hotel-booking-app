...
const GuestHouses = ( ) => {
  ...
  useEffect(()=> {
    const fetchListings = async () => {
      try {
        ...
        const gestHouseListings = data.filter(listing => listing.hotelType === 'guestHouse');
        setListings(gestHouseListings);
        setLoading(false);
      } catch (error) {
  ...
  return (
    <div className='container mx-auto p-6'>
      <h1 className='text-3xl font-thin underline text-black font-serif text-center mb-10'>Guest Houses</h1>
