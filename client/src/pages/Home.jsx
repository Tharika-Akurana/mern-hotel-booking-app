...
const Home = () => {
  ...
  const categories = [
    ...
    },
    {
      ...
      detailDescription:
        "Resorts provide a perfect getaway with luxurious amenities and stunning views. Guests can lounge by the pool, enjoy spa treatments, or engage in outdoor activities, making resorts ideal for a relaxing and rejuvenating vacation. Resorts stand out from other hotel types by offering extensive recreational facilities and a focus on leisure and relaxation. Users choose resorts for their all-inclusive packages, beautiful locations, and the opportunity to unwind and indulge.",
      img: resort,
    },
    {
      name: "Budget Hotels",
    ...
    <div className="container mx-auto p-10">
          ...
          <SwiperSlide key={index}>
            ...
            >
              ...
              <div style={textCenterStyle} className="slide-content text-white">
                <h2 className="slide-item text-4xl font-bold font-serif">
                  {category.name}
                </h2>
                <p className="slide-item text-xl mt-2">
                  {category.sliderDescription}
                </p>
                <a href={category.link}>
                  <button className="slide-item mt-4 px-6 py-2 bg-goldLeaf text-white rounded-md hover:bg-darkGold">
                    More
                  </button>
                </a>
              </div>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
        {categories.map((category, index) => (
          ...
          >
            <div>
              <h3 className="text-2xl font-sans font-bold text-DeepNavyBlue">
                {category.name}
              </h3>
            ...
            <div className="flex justify-end mt-6">
              <a href={category.link}>
                <button className="mt-6 px-4 py-2 bg-darkGold text-white rounded-md hover:bg-goldLeaf">
                  Explore...
                </button>
              </a>
            </div>
