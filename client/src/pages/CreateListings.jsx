  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <form
        ...
        className="space-y-6 text-base font-semibold"
      >
        {/* Basic Hotel Information */}
        <div>
          <label className="block mb-2 font-sans text-justify">
            {" "}
            Hotel Name{" "}
          </label>
          <input
        ...
        {/* Hotel Types */}
        <div>
          <label className="block mb-3 font-sans text-justify ">
            {" "}
            Types of Hotels
          </label>
        ...
        {formData.hotelType === "restaurant" ? (
          <div>
            <label className="block mb-2 font-sans text-justify">
              {" "}
              Price per Person for an Hour (USD){" "}
            </label>
            <input
              type="number"
              name="pricePerPerson"
        ...
        ) : formData.hotelType === "business" ||
          formData.hotelType === "budget" ||
          formData.hotelType === "guestHouse" ||
          formData.hotelType === "transient" ? (
          <div>
            <label className="block mb-2 font-sans text-justify">
              {" "}
              Price per Night (USD){" "}
        ...
        ) : formData.hotelType === "resort" ||
          formData.hotelType === "boutique" ||
          formData.hotelType === "luxury" ? (
          <div>
            <label className="block mb-2 font-sans text-justify">
              {" "}
              Pricing Details{" "}
