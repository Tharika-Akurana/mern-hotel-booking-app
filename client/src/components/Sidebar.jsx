  ...
  return (
    <div className='w-44 h-auto bg-DeepNavyBlue text-white flex flex-col justify-between'>
      ...
      <div className='p-4 text-center mb-4'>
        <Link to="/">
          <img src={logo} alt="Logo" className=' hover:text-darkGold mx-auto mb-4 w-16 h-16 rounded-full' /> 
      ...
      <nav className='flex-grow items-center justify-center'>
        <Link to="/create-listings" className='block py-3 px-4 hover:text-goldenYellow '>
          Add Hotel
        </Link>
        <Link to="/edit-listings" className='block py-3 px-4 hover:text-goldenYellow'>
          Edit Hotel
        </Link>
        <Link to="/listings" className='block py-3 px-4 hover:text-goldenYellow'>
           Hotels
        </Link>
